...
public class JoystickView extends View implements Runnable {
    ...
    protected void initJoystickView() {
        ...
        mainCircle.setColor(0x88FFFFFF);
        mainCircle.setStyle(Paint.Style.FILL_AND_STROKE);

        secondaryCircle = new Paint();
        secondaryCircle.setStrokeWidth(10);
        secondaryCircle.setColor(typedValue.data);
        ...
        button.setColor(typedValue.data);
    ...
    protected void onSizeChanged(int xNew, int yNew, int xOld, int yOld) {
        ...
        buttonRadius = (int) (d / 2 * 0.3125);
        joystickRadius = (int) (d / 2 * 0.625);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle((int) centerX, (int) centerY, joystickRadius / 3,
                secondaryCircle);
        // paint lines
